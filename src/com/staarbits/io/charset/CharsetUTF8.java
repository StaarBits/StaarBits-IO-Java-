...
/**
 * The "CharsetUTF8" is an extension of <code>{@link AbstractCharset}</code> and an implementation of <code>{@link Charset}</code>
 * which is equivalent to "UTF-8".
 */
public class CharsetUTF8 extends AbstractCharset implements Charset
{
    ...
    {
        if (charset instanceof CharsetUTF8)
        {
            return 0;
